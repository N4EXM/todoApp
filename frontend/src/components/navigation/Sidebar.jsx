...
const Sidebar = () => {
    ...
    return (
        <>
            <div
                className='p-4 w-4/16 h-screen bg-slate-200 dark:bg-slate-900 flex flex-col gap-40 font-poppins relative border-r-2 dark:border-slate-800 border-slate-200'
            >
                ...
                >
                    ...
                    <h1
                        className='font-semibold text-2xl dark:text-slate-200'
                    >
                        ClearFlow
                    </h1>
                </div>
                ...
                >
                    <Link
                        to={'/'}
                        className={`p-2 rounded-md font-medium w-full flex-row flex gap-3 items-center border-2 border-slate-200 dark:border-slate-900 hover:border-emerald-500 duration-200 ${location.pathname === '/' ? 'bg-emerald-500  hover:border-slate-200 text-slate-200 dark:text-slate-200 dark:hover:border-slate-950' : 'dark:text-slate-300 text-slate-600'}`}
                    >
            ...
            >
                ...
                <div
                    className='flex flex-col gap-3 p-5 items-center w-104 h-56 bg-slate-200 dark:bg-slate-800 rounded-md'
                >
                    <i
