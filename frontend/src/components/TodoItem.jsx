...
const TodoItem = ({id, title, completed, updateTitle, deleteFunction, onToggle}) => {
  ...
  return (
    <div
        className='flex flex-row items-center justify-between p-2 border-2 rounded-md w-full'
    >
        <div
